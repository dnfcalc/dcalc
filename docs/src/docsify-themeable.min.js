...
!(function () {
  ...
  function c(e, t, n) {
    ...
    if (i >= 0 && u > 0) {
      ...
      for (r = [], a = n.length; l >= 0 && !c; )
        l == i ? (r.push(l), (i = n.indexOf(e, l + 1))) : 1 == r.length ? (c = [r.pop(), u]) : ((o = r.pop()) < a && ((a = o), (s = u)), (u = n.indexOf(t, l + 1))), (l = i < u && i >= 0 ? i : u)
      r.length && (c = [a, s])
    }
    return c
  }
        ...
        for (var n = 0; n < e.length; n++) {
          ...
          if ("declaration" === a)
            if (o.preserveVars || !s || 0 !== s.indexOf("--")) {
              if (-1 !== c.indexOf("var(")) {
                var i = p(c, o)
                i !== r.value && ((i = m(i)), o.preserveVars ? (e.splice(n, 0, { type: a, property: s, value: i }), n++) : (r.value = i))
              }
            } else e.splice(n, 1), n--
        }
      }),
  ...
  function p(e) {
    ...
    function a(e) {
      var r = e.split(",")[0].replace(/[\s\n\t]/g, ""),
        ...
        c = n || e
      return a || t.onWarning('variable "'.concat(r, '" is undefined')), s && "undefined" !== s && s.length > 0 ? p(s, t, c) : "var(".concat(c, ")")
    }
    if (r) {
  ...
  function L() {
    ...
    if (v) {
      if (o.watch) return (o.watch = g.watch), k(o), void L(o)
      if ((!1 === o.watch && S && (S.disconnect(), (S = null)), !o.__benchmark)) {
        ...
        if (
          ((o.__benchmark = N()),
          (o.exclude = [S ? '[data-cssvars]:not([data-cssvars=""])' : '[data-cssvars="out"]', "link[disabled]:not([data-cssvars])", o.exclude]
            .filter(function (e) {
              return e
            })
            .join(",")),
          ...
          !A && (o.shadowDOM || o.rootElement.shadowRoot || o.rootElement.host)
            ? n({
                ...
                onComplete: function (e, t, n) {
                  u(e, { store: w.dom, onWarning: s }), (A = !0), L(o)
                }
              })
            : ((E = o.rootElement),
              n({
                ...
                onSuccess: function (e, t, n) {
                  ...
                  var r = "link" === t.nodeName.toLowerCase(),
                    ...
                    s = o.onSuccess(e, t, n)
                  return (e = void 0 !== s && !1 === Boolean(s) ? "" : s || e), o.updateURLs && (r || a) && (e = M(e, n)), e
                },
                onComplete: function (t, n) {
                  ...
                  if (
                    ...
                    r.forEach(function (e, t) {
                      ...
                      if (((e.__cssVars = e.__cssVars || {}), (e.__cssVars.text = r), b.cssVars.test(r)))
                        try {
                          ...
                          u(c, { parseHost: Boolean(o.rootElement.host), store: w.dom, onWarning: s }), (e.__cssVars.tree = c)
                        } catch (t) {
                          a(t.message, e)
                        }
                    }),
                    e(w.job, w.dom),
                    o.updateDOM ? (e(w.user, o.variables), e(w.job, w.user)) : (e(w.job, w.user, o.variables), e(d, o.variables)),
                    y.job > 0 &&
                      Boolean(
                    ...
                    if (
                        ...
                        if (t.__cssVars.tree)
                          try {
                            ...
                            if (o.updateDOM) {
                              ...
                              if ((t.getAttribute("data-cssvars") || t.setAttribute("data-cssvars", "src"), i.length && d)) {
                      ...
                      for (var h, g = [].concat(o.rootElement).concat([].slice.call(o.rootElement.querySelectorAll("*"))), S = 0; (h = g[S]); ++S)
                        if (h.shadowRoot && h.shadowRoot.querySelector("style")) {
                          var x = e({}, o, { rootElement: h.shadowRoot })
                          L(x)
                        }
                    o.updateDOM && v && _(o.rootElement), (E = !1), o.onComplete(m.join(""), p, JSON.parse(JSON.stringify(w.job)), N() - o.__benchmark), c(p.length)
                  }
                }
              }))
      else
          ...
          return (
            (function (r) {
              ...
              if ("attributes" === r.type && n(r.target) && !t(r.target)) {
                ...
                a ? (o = !c && !i) : s && (c ? r.target.setAttribute("data-cssvars", "") : i && V(e.rootElement, !0), (o = !0))
              }
              return o
            })(o) ||
            (function (e) {
  ...
  function q(e, t) {
    ...
    if (r && o) {
      ...
      if (!a) {
        ...
        for (null !== n && s.setAttribute("tabindex", n), e.insertBefore(s, o); e.childNodes[0] !== s; ) s.appendChild(e.childNodes[0])
      }
    }
  }
  L.reset = function () {
    for (var e in ((y.job = 0), (y.group = 0), (E = !1), S && (S.disconnect(), (S = null)), (C = 0), (x = null), (A = !1), w)) w[e] = {}
  }
  var R = "0.9.0"
  function D(e, t) {
  ...
  if (window) {
    var B = { onlyLegacy: !/Edge\/1[5678]/i.test(navigator.userAgent), silent: !0 }
    L(B),
                ...
                !1 !== ((window.$docsify || {}).themeable || {}).readyTransition &&
                  ...
                  e.ready(function () {
                    ...
                    e.addEventListener("transitionend", function t(n) {
                      document.body.classList.remove("ready-transition"), document.body.classList.remove("ready-spinner"), e.removeEventListener("transitionend", t)
                    })
                  }))
              })
            },
      ...
      (window.$docsify.themeable.version = R),
      (window.$docsify.themeable.semver = R.split(".")),
