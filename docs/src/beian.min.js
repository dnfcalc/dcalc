    ...
    next(
      html +
        `\n            <hr>\n            <footer class="beian" style="text-align: center;">\n                <a style="text-decoration: none; color: #34495e; font-size: 15px; font-weight: 400;" href="https://beian.miit.gov.cn/#/Integrated/recordQuery" target="_blank">${
          ...
          window.$docsify["beian"].NISMSP && window.$docsify["beian"].NISMSP.number.length !== 0
            ? `\n                        &nbsp;&nbsp;\n                    <a style="text-decoration: none; color: #34495e; font-size: 15px; font-weight: 400;" href="${
                !window.$docsify["beian"].NISMSP.id ? window.$docsify["beian"].NISMSP.url : `http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=${window.$docsify["beian"].NISMSP.id}`
...
window.$docsify["beian"] = Object.assign({ ICP: "", NISMSP: { number: "", url: "", id: "" } }, window.$docsify["beian"])
