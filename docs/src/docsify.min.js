!(function () {
      ...
      return (
        ...
        (e.prototype.onchange = function (i) {
          ...
          p("click", function (e) {
            ...
            e && "A" === e.tagName && !/_blank/.test(e.target) && (o = !0)
          }),
        ...
        (e.prototype.onchange = function (i) {
          ...
          void 0 === i && (i = d),
            p("click", function (e) {
              ...
              n &&
                "A" === n.tagName &&
                !/_blank/.test(n.target) &&
                (e.preventDefault(),
                (n = n.href),
                -1 !== o.config.crossOriginLinks.indexOf(n) ? window.open(n, "_self") : window.history.pushState({ key: n }, "", n),
      ...
      r.send(),
      {
        then: function (n, i) {
          ...
          void 0 === i && (i = d),
            ...
            a("load", function (e) {
              var e = e.target
              400 <= e.status ? i(e) : ((e = W[t] = { content: e.response, opt: { updatedAt: r.getResponseHeader("last-modified") } }), n(e.content, e.opt))
            })
        },
        abort: function (e) {
      ...
      },
      {
        ...
        value: function (e) {
          ...
          this.timeStart || (this.timeStart = e),
            ...
            this._shouldTick(n)
              ? (this._emit("tick", this.tweener.getIntermediateValue(this.next)), (this.frame = window.requestAnimationFrame(this._tick.bind(this))))
      ...
      !n ||
        ((r = fe[ve(e, n.getAttribute("data-id"))]) &&
          ...
          !pe &&
            ...
            ((e = i.clientHeight), (r = a.offsetTop + a.clientHeight + 40), (a = a.offsetTop >= t.scrollTop && r <= t.scrollTop + e), (i.scrollTop = a ? t.scrollTop : +r < e ? 0 : r - e))))
    }
  }
  function ve(e, n) {
  ...
  function he(e, n) {
    ...
    n &&
      ...
      (i = b("#" + n)) &&
        ...
        de && de.stop(),
        (ge = !1),
        (de = new ae({ start: window.pageYOffset, end: Math.round(i.getBoundingClientRect().top) + window.pageYOffset - o, duration: 500 })
          .on("tick", function (e) {
  ...
  var Re = {},
    ...
    Le = /^([^:]+:\/*[^/]*)[\s\S]*$/
  function qe(e, n) {
    Re[" " + e] || (je.test(e) ? (Re[" " + e] = e + "/") : (Re[" " + e] = Pe(e, "/", !0)))
    var i = -1 === (e = Re[" " + e]).indexOf(":")
    return "//" === n.substring(0, 2) ? (i ? n : e.replace(Oe, "$1") + n) : "/" === n.charAt(0) ? (i ? n : e.replace(Le, "$1") + n) : e + n
  }
  function Pe(e, n, i) {
    var o = e.length
    if (0 === o) return ""
  ...
  function en(e, n, i) {
    var o = n.href,
      ...
      n = e[1].replace(/\\([\[\]])/g, "$1")
    return "!" !== e[0].charAt(0) ? { type: "link", raw: i, href: o, title: t, text: n } : { type: "image", raw: i, href: o, title: t, text: Je(n) }
  }
  var nn = (function () {
      function e(e) {
        this.options = e || We
      ...
      return (
        ...
        (e.prototype.heading = function (e) {
          ...
          if (n) {
            var i = n[2].trim()
            return /#$/.test(i) && ((e = Xe(i, "#")), (!this.options.pedantic && e && !/ $/.test(e)) || (i = e.trim())), { type: "heading", raw: n[0], depth: n[1].length, text: i }
          }
        }),
          ...
          if (e) {
            for (
              ...
              if (((r = n = p[l]), l !== g - 1)) {
                ...
                ;(!this.options.pedantic || this.options.smartLists ? o[2][o[2].length - 1] !== c[c.length - 1] : u == (1 === o[2].length)) &&
                  ((i = p.slice(l + 1).join("\n")), (f.raw = f.raw.substring(0, f.raw.length - i.length)), (l = g - 1)),
                  (s = o)
              }
              ;(o = n.length),
                ~(n = n.replace(/^ *([*+-]|\d+[.)]) ?/, "")).indexOf("\n ") &&
                  ((o -= n.length), (n = this.options.pedantic ? n.replace(/^ {1,4}/gm, "") : n.replace(new RegExp("^ {1," + o + "}", "gm"), ""))),
                (o = d || /\n\n(?!\s*$)/.test(n)),
                l !== g - 1 && ((d = "\n" === n.charAt(n.length - 1)), (o = o || d)),
                o && (f.loose = !0),
                this.options.gfm && ((a = void 0), (t = /^\[[ xX]\] /.test(n)) && ((a = " " !== n[1]), (n = n.replace(/^\[[ xX]\] +/, "")))),
        ...
        (e.prototype.table = function (e) {
          ...
          if (e) {
            var n = { type: "table", header: Qe(e[1].replace(/^ *| *\| *$/g, "")), align: e[2].replace(/^ *|\| *$/g, "").split(/ *\| */), cells: e[3] ? e[3].replace(/\n$/, "").split("\n") : [] }
            if (n.header.length === n.align.length) {
              n.raw = e[0]
              for (var i = n.align.length, o = 0; o < i; o++)
                /^ *-+: *$/.test(n.align[o])
        ...
        (e.prototype.link = function (e) {
          ...
          if (n) {
            ...
            var t,
              ...
              o = ""
            return (
              this.options.pedantic ? (t = /^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(i)) && ((i = t[1]), (o = t[3])) : (o = n[3] ? n[3].slice(1, -1) : ""),
              (i = i.trim()),
              en(
                n,
                {
        ...
        (e.prototype.strong = function (e, n, i) {
          ...
          if (o && (!o[1] || (o[1] && ("" === i || this.rules.inline.punctuation.exec(i))))) {
            ...
            for (a.lastIndex = 0; null != (o = a.exec(n)); )
              if ((t = this.rules.inline.strong.middle.exec(n.slice(0, o.index + 3)))) return { type: "strong", raw: e.slice(0, t[0].length), text: e.slice(2, t[0].length - 2) }
          }
        }),
        (e.prototype.em = function (e, n, i) {
          ...
          if (o && (!o[1] || (o[1] && ("" === i || this.rules.inline.punctuation.exec(i))))) {
            ...
            for (a.lastIndex = 0; null != (o = a.exec(n)); )
              if ((t = this.rules.inline.em.middle.exec(n.slice(0, o.index + 2)))) return { type: "em", raw: e.slice(0, t[0].length), text: e.slice(1, t[0].length - 1) }
          }
        }),
        (e.prototype.codespan = function (e) {
          ...
          if (n) {
            var i = n[2].replace(/\n/g, " "),
              o = /[^ ]/.test(i),
              e = /^ /.test(i) && / $/.test(i)
            return o && e && (i = i.substring(1, i.length - 1)), (i = Je(i, !0)), { type: "codespan", raw: n[0], text: i }
          }
        }),
  ...
  function un(e) {
    for (var n, i = "", o = e.length, t = 0; t < o; t++) (n = e.charCodeAt(t)), (i += "&#" + (n = 0.5 < Math.random() ? "x" + n.toString(16) : n) + ";")
    return i
  }
  var fn = (function () {
      function i(e) {
        ...
        this.options.pedantic ? ((e.block = tn.pedantic), (e.inline = an.pedantic)) : this.options.gfm && ((e.block = tn.gfm), this.options.breaks ? (e.inline = an.breaks) : (e.inline = an.gfm)),
      ...
      return (
        ...
        (i.prototype.blockTokens = function (e, n, i) {
          var o, t, a, r
          for (void 0 === n && (n = []), void 0 === i && (i = !0), this.options.pedantic && (e = e.replace(/^ +$/gm, "")); e; )
            if ((o = this.tokenizer.space(e))) (e = e.substring(o.raw.length)), o.type && n.push(o)
            else if ((o = this.tokenizer.code(e, n))) (e = e.substring(o.raw.length)), o.type ? n.push(o) : (((r = n[n.length - 1]).raw += "\n" + o.raw), (r.text += "\n" + o.text))
            ...
            else if ((o = this.tokenizer.blockquote(e))) (e = e.substring(o.raw.length)), (o.tokens = this.blockTokens(o.text, [], i)), n.push(o)
            ...
            else if (i && (o = this.tokenizer.def(e))) (e = e.substring(o.raw.length)), this.tokens.links[o.tag] || (this.tokens.links[o.tag] = { href: o.href, title: o.title })
            ...
            else if ((o = this.tokenizer.text(e, n))) (e = e.substring(o.raw.length)), o.type ? n.push(o) : (((r = n[n.length - 1]).raw += "\n" + o.raw), (r.text += "\n" + o.text))
            else if (e) {
          ...
          for (var n, i, o, t, a, r = e.length, c = 0; c < r; c++)
            switch ((a = e[c]).type) {
              ...
              case "heading":
                ...
                break
              case "table":
                for (a.tokens = { header: [], cells: [] }, o = a.header.length, n = 0; n < o; n++) (a.tokens.header[n] = []), this.inlineTokens(a.header[n], a.tokens.header[n])
                for (o = a.cells.length, n = 0; n < o; n++)
                  for (t = a.cells[n], a.tokens.cells[n] = [], i = 0; i < t.length; i++) (a.tokens.cells[n][i] = []), this.inlineTokens(t[i], a.tokens.cells[n][i])
                break
              case "blockquote":
        ...
        (i.prototype.inlineTokens = function (e, n, i, o) {
          ...
          for (; e; )
            ...
            else if ((t = this.tokenizer.tag(e, i, o))) (e = e.substring(t.raw.length)), (i = t.inLink), (o = t.inRawBlock), n.push(t)
            else if ((t = this.tokenizer.link(e))) (e = e.substring(t.raw.length)), "link" === t.type && (t.tokens = this.inlineTokens(t.text, [], !0, o)), n.push(t)
            else if ((t = this.tokenizer.reflink(e, this.tokens.links))) (e = e.substring(t.raw.length)), "link" === t.type && (t.tokens = this.inlineTokens(t.text, [], !0, o)), n.push(t)
            else if ((t = this.tokenizer.strong(e, u, c))) (e = e.substring(t.raw.length)), (t.tokens = this.inlineTokens(t.text, [], i, o)), n.push(t)
            else if ((t = this.tokenizer.em(e, u, c))) (e = e.substring(t.raw.length)), (t.tokens = this.inlineTokens(t.text, [], i, o)), n.push(t)
            ...
            else if ((t = this.tokenizer.del(e))) (e = e.substring(t.raw.length)), (t.tokens = this.inlineTokens(t.text, [], i, o)), n.push(t)
            else if ((t = this.tokenizer.autolink(e, un))) (e = e.substring(t.raw.length)), n.push(t)
            else if (i || !(t = this.tokenizer.url(e, un))) {
              if ((t = this.tokenizer.inlineText(e, o, cn))) (e = e.substring(t.raw.length)), (c = t.raw.slice(-1)), (r = !0), n.push(t)
              else if (e) {
          ...
          for (var i, o, t, a, r, c, u, f, p, d, g, s, l, v, h, _ = "", m = e.length, b = 0; b < m; b++)
            switch ((f = e[b]).type) {
              ...
              case "code":
                ...
                continue
              case "table":
                for (c = p = "", t = f.header.length, i = 0; i < t; i++) c += this.renderer.tablecell(this.parseInline(f.tokens.header[i]), { header: !0, align: f.align[i] })
                for (p += this.renderer.tablerow(c), u = "", t = f.cells.length, i = 0; i < t; i++) {
                  for (c = "", a = (r = f.tokens.cells[i]).length, o = 0; o < a; o++) c += this.renderer.tablecell(this.parseInline(r[o]), { header: !1, align: f.align[o] })
                      ...
                      d
                        ? 0 < s.tokens.length && "text" === s.tokens[0].type
                          ? ((s.tokens[0].text = h + " " + s.tokens[0].text),
                            s.tokens[0].tokens && 0 < s.tokens[0].tokens.length && "text" === s.tokens[0].tokens[0].type && (s.tokens[0].tokens[0].text = h + " " + s.tokens[0].tokens[0].text))
            ...
            ? e && /unicode/.test(n)
              ? '<span class="emoji">' +
                n
                  ...
                  .concat("&#xFE0E;") +
                "</span>"
              : '<img src="' + Rn.baseURL + n + '.png" alt="' + o + '" class="emoji" loading="lazy">'
            : i)
        )
        var i, o
      })
    ...
    Pn = be(function (e) {
        ...
        g = (function (u) {
          var i = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i,
            ...
            T = {
              ...
              util: {
                encode: function e(n) {
                  return n instanceof C
                    ? new C(n.type, e(n.content), n.alias)
                    : Array.isArray(n)
                    ? n.map(e)
                    : n
                        .replace(/&/g, "&amp;")
                ...
                clone: function i(e, o) {
                  var t, n
                  switch (((o = o || {}), T.util.type(e))) {
                    case "Object":
                      if (((n = T.util.objId(e)), o[n])) return o[n]
                      for (var a in ((t = {}), (o[n] = t), e)) e.hasOwnProperty(a) && (t[a] = i(e[a], o))
                      return t
                    case "Array":
                      return ((n = T.util.objId(e)), o[n])
                        ? o[n]
                        : ((t = []),
                          (o[n] = t),
                ...
                DFS: function e(n, i, o, t) {
                  ...
                  for (a in n)
                    n.hasOwnProperty(a) &&
                      (i.call(n, a, n[a], o || a),
                      (r = n[a]),
                      "Object" !== (c = T.util.type(r)) || t[u(r)] ? "Array" !== c || t[u(r)] || ((t[u(r)] = !0), e(r, i, a, t)) : ((t[u(r)] = !0), e(r, i, null, t)))
                }
              },
              plugins: {},
              ...
              highlightAllUnder: function (e, n, i) {
                var o = { callback: i, container: e, selector: 'code[class*="language-"], [class*="language-"] code, code[class*="lang-"], [class*="lang-"] code' }
                T.hooks.run("before-highlightall", o), (o.elements = Array.prototype.slice.apply(o.container.querySelectorAll(o.selector))), T.hooks.run("before-all-elements-highlight", o)
                for (var t, a = 0; (t = o.elements[a++]); ) T.highlightElement(t, !0 === n, o.callback)
              },
              highlightElement: function (e, n, i) {
                var o = T.util.getLanguage(e),
                  t = T.languages[o]
                T.util.setLanguage(e, o)
                var a = e.parentElement
                a && "pre" === a.nodeName.toLowerCase() && T.util.setLanguage(a, o)
                ...
                if (
                  ...
                  return T.hooks.run("complete", r), void (i && i.call(r.element))
                T.hooks.run("before-highlight", r),
                  r.grammar
                    ? n && u.Worker
                      ? (((n = new Worker(T.filename)).onmessage = function (e) {
                          c(e.data)
                        }),
                        n.postMessage(JSON.stringify({ language: r.language, code: r.code, immediateClose: !0 })))
                      : c(T.highlight(r.code, r.grammar, r.language))
                    : c(T.util.encode(r.code))
              },
              highlight: function (e, n, i) {
                i = { code: e, grammar: n, language: i }
                if ((T.hooks.run("before-tokenize", i), !i.grammar)) throw new Error('The language "' + i.language + '" has no grammar.')
                return (i.tokens = T.tokenize(i.code, i.grammar)), T.hooks.run("after-tokenize", i), C.stringify(T.util.encode(i.tokens), i.language)
              },
                        ...
                        for (var f = 0; f < u.length; ++f) {
                          ...
                          for (var h = d.pattern || d, _ = t.next, m = a; _ !== i.tail && !(r && m >= r.reach); m += _.value.length, _ = _.next) {
                            ...
                            if (!(b instanceof C)) {
                              ...
                              b = _.prev
                              z && ((b = j(i, b, z)), (m += z.length)), O(i, b, w)
                              $ = new C(c, g ? T.tokenize($, g) : $, v, $)
                              ;(_ = j(i, b, $)), F && j(i, _, F), 1 < w && ((E = { cause: c + "," + f, reach: E }), e(n, i, o, _.prev, m, E), r && E.reach > r.reach && (r.reach = E.reach))
                            }
                          }
                        }
                      }
          ...
          if (
            ...
            (C.stringify = function n(e, i) {
              ...
              var t = { type: e.type, content: n(e.content, i), tag: "span", classes: ["token", e.type], attributes: {}, language: i },
                e = e.alias
              e && (Array.isArray(e) ? Array.prototype.push.apply(t.classes, e) : t.classes.push(e)), T.hooks.run("wrap", t)
              var a,
                r = ""
                  ...
                  u.addEventListener(
                    ...
                    function (e) {
                      var n = JSON.parse(e.data),
                        ...
                        e = n.code,
                        n = n.immediateClose
                      u.postMessage(T.highlight(e, T.languages[i], i)), n && u.close()
                    },
                    !1
                  )),
              T
            )
          var o = T.util.currentScript()
          function t() {
            T.manual || T.highlightAll()
          }
          return (
            o && ((T.filename = o.src), o.hasAttribute("data-manual") && (T.manual = !0)),
            T.manual ||
      ...
      e.exports && (e.exports = g),
        ...
        Object.defineProperty(g.languages.markup.tag, "addInlined", {
          value: function (e, n) {
            var i = {}
            ;(i["language-" + n] = { pattern: /(^<!\[CDATA\[)[\s\S]+?(?=\]\]>$)/i, lookbehind: !0, inside: g.languages[n] }), (i.cdata = /^<!\[CDATA\[|\]\]>$/i)
            ...
            g.languages.markup.tag.inside["special-attr"].push({
              ...
              inside: {
                ...
                "attr-value": {
                  pattern: /=[\s\S]+/,
                  inside: {
                    value: { pattern: /(^=\s*(["']|(?!["'])))\S[\s\S]*(?=\2$)/, lookbehind: !0, alias: [n, "language-" + n], inside: g.languages[n] },
        ...
        g.languages.insertBefore("javascript", "keyword", {
          regex: {
            ...
            greedy: !0,
            inside: {
              "regex-source": { pattern: /^(\/)[\s\S]+(?=\/[a-z]*$)/, lookbehind: !0, alias: "language-regex", inside: g.languages.regex },
              "regex-delimiter": /^\/|\/$/,
              "regex-flags": /^[a-z]+$/
            }
          },
      ...
      (this.compile = function (i) {
        var o = !0,
          e = c(function (e) {
            o = !1
            var n = ""
            return i && ((n = f(i) ? r(i) : r.parser(i)), (n = t.noEmoji ? n : jn(n, t.nativeEmoji)), Cn.clear(), n)
          })(i),
  ...
  ;(In.prototype.compileEmbed = function (e, n) {
    ...
    if (((n = a), t.include))
      return (
        T(e) || (e = q(this.contentBase, R(this.router.getCurrentPath()), e)),
        t.type && (o = Hn[t.type])
        ...
        (t.heading = e.heading =
          function (e, n) {
            var i = On(e),
              o = i.str,
              t = i.config,
              e = { level: n, title: Ln(o) }
            ;/<!-- {docsify-ignore} -->/g.test(o) && ((o = o.replace("\x3c!-- {docsify-ignore} --\x3e", "")), (e.title = Ln(o)), (e.ignoreSubHeading = !0)),
              /{docsify-ignore}/g.test(o) && ((o = o.replace("{docsify-ignore}", "")), (e.title = Ln(o)), (e.ignoreSubHeading = !0)),
              /<!-- {docsify-ignore-all} -->/g.test(o) && ((o = o.replace("\x3c!-- {docsify-ignore-all} --\x3e", "")), (e.title = Ln(o)), (e.ignoreAllSubs = !0)),
              /{docsify-ignore-all}/g.test(o) && ((o = o.replace("{docsify-ignore-all}", "")), (e.title = Ln(o)), (e.ignoreAllSubs = !0))
            ;(i = Cn(t.id || o)), (t = a.toURL(a.getCurrentPath(), { id: i }))
        ...
        (t.link =
          ...
          (i.link = function (e, n, i) {
            ...
            return (
              ...
              (n = a),
              T(e) || f._matchNotCompileLink(e) || t.ignore
                ? (T(e) || "./" !== e.slice(0, 2) || (e = document.URL.replace(/\/(?!.*\/).*/, "/").replace("#/./", "") + e),
              ...
              t.crossorgin && "_self" === u && "history" === f.config.routerMode && -1 === f.config.crossOriginLinks.indexOf(e) && f.config.crossOriginLinks.push(e),
        ...
        (t.image =
          ...
          (o.image = function (e, n, i) {
            ...
            return (
              ...
              n && t.push('title="' + n + '"'),
              a.size && ((n = (r = a.size.split("x"))[0]), (r = r[1]) ? t.push('width="' + n + '" height="' + r + '"') : t.push('width="' + n + '"')),
              a.class && t.push('class="' + a.class + '"'),
              a.id && t.push('id="' + a.id + '"'),
              T(e) || (o = q(p, R(d.getCurrentPath()), e)),
        ...
        (t.list = { renderer: e }.renderer.list =
          function (e, n, i) {
            ...
            return (
              ...
              n +
              " " +
              [/<li class="task-list-item">/.test(e.split('class="task-list"')[0]) ? 'class="task-list"' : "", i && 1 < i ? 'start="' + i + '"' : ""].join(" ").trim() +
              ">" +
              e +
              "</" +
              n +
          ...
          return function (e) {
            ...
            e &&
              ("markdown" === t.embed.type
                ...
                : "code" === t.embed.type
                ? (t.embed.fragment &&
                    ((o = t.embed.fragment), (o = new RegExp("(?:###|\\/\\/\\/)\\s*\\[" + o + "\\]([\\s\\S]*)(?:###|\\/\\/\\/)\\s*\\[" + o + "\\]")), (e = Dn((e.match(o) || [])[1] || "").trim())),
        ...
        (function (e) {
          ...
          return (
            ...
            (((n.prototype = Object.create(e && e.prototype)).constructor = n).prototype.$resetEvents = function (e) {
              ...
              "history" !== e && (n.route.query.id && he(n.route.path, n.route.query.id), "navigate" === e && i && ((i = i), (_e.scrollTop = !0 === (i = void 0 === i ? 0 : i) ? 0 : Number(i)))),
            ...
            return (
              ...
              (n.prototype._renderCover = function (e, n) {
                ...
                S(l("main"), n ? "add" : "remove", "hidden"),
                  e
                    ? (S(o, "add", "show"),
                      (n = (i = this.coverIsHTML ? e : this.compiler.cover(e)).trim().match('<p><img.*?data-origin="(.*?)"[^a]+alt="(.*?)">([^<]*?)</p>$')) &&
                        ("color" === n[2]
                          ? (o.style.background = n[1] + (n[3] || ""))
                          : ((e = n[1]),
                            S(o, "add", "has-mask"),
                            T(n[1]) || (e = q(this.router.getBasePath(), n[1])),
              ...
              (n.prototype.initRender = function () {
                ...
                u
                    ...
                    e.coverpage &&
                      (f +=
                        ...
                        '<section class="cover show" style="background: ' +
                          ("linear-gradient(to left bottom, hsl(" + Math.floor(255 * Math.random()) + o + ") 0%,hsl(" + Math.floor(255 * Math.random()) + o + ") 100%)") +
                          '"><div class="mask"></div><div class="cover-main">\x3c!--cover--\x3e</div></section>')),
                    e.logo && ((o = /^data:image/.test(e.logo)), (n = /(?:http[s]?:)?\/\//.test(e.logo)), (i = /^\./.test(e.logo)), o || n || i || (e.logo = q(this.router.getBasePath(), e.logo))),
                    (f +=
                      ((i = (n = e).name || ""),
                      "<main>" +
                        ('<button class="sidebar-toggle" aria-label="Menu"><div class="sidebar-toggle-button"><span></span><span></span><span></span></div></button><aside class="sidebar">' +
                          (n.name ? '<h1 class="app-name"><a class="app-name-link" data-nosearch>' + (n.logo ? '<img alt="' + i + '" src=' + n.logo + ">" : i) + "</a></h1>" : "") +
                  ...
                  : (this.rendered = !0),
                  e.mergeNavbar && s ? (p = b(".sidebar")) : (c.classList.add("app-nav"), e.repo || c.classList.add("no-badge")),
                  e.loadNavbar && y(p, c),
                  e.themeColor &&
                    (v.head.appendChild(w("div", "<style>:root{--theme-color: " + e.themeColor + ";}</style>").firstElementChild),
                    (a = e.themeColor),
  ...
  ;(window.Docsify = { util: Me, dom: n, get: X, slugify: Cn, version: "4.13.0" }),
