...
@register
def enchant_5(char: CharacterProperty):
    """
    DCALC_REMOVE: enchant_5
    三攻(20)|四维(75)|技攻(7%)
    """
...
@register
def enchant_2510(char: CharacterProperty):
    """
    DCALC_REMOVE: enchant_2510
    攻击强化(12%)
    """
    char.SetStatus(攻击强化P=0.12)
    pass
