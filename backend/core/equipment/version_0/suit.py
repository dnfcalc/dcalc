...
def suit_37(char: CharacterProperty):
    ...
    # level: 1
    # value: 召唤精灵一起战斗。  [火灵安珀] 每2秒施放一次火花：伤害量19,200% 每3秒恢复1%的生命值  [水灵阿库娅] 每3秒施放一次水弹：伤害量24,000% 每3秒恢复1%的魔法值  [停止攻击开关][装备主动技能]控制精灵们的攻击。 - 攻击中止/继续攻击 - 冷却时间1秒  [风灵希尔珂] 每2秒施放一次刀风：伤害量20,500% 移动速度 +15%  [停止攻击开关][装备主动技能]控制精灵们的攻击。 - 攻击中止/继续攻击 - 冷却时间1秒  [元素释放][装备主动技能]对精灵下达协同攻击指令。 - 消耗150精灵之魂 - 攻击时，精灵之魂 +10（冷却时间1秒） - 被击时，精灵之魂 -5（冷却时间1秒） - 元素释放伤害量：158200%
    # rarity: 史诗
    char.equ_effect.append(EquEffect(name='火灵安珀', icon='/equipment/skill/29.png', cd=2, data=19200))
    char.equ_effect.append(EquEffect(name='水灵阿库娅', icon='/equipment/skill/29.png', cd=3, data=24000))
...
def suit_42(char: CharacterProperty):
    ...
    # level: 1
    # value: 召唤精灵一起战斗。  [火灵安珀] 每2秒施放一次火花：伤害量19,200% 每3秒恢复1%的生命值  [水灵阿库娅] 每3秒施放一次水弹：伤害量24,000% 每3秒恢复1%的魔法值  [停止攻击开关][装备主动技能]控制精灵们的攻击。 - 攻击中止/继续攻击 - 冷却时间1秒  [风灵希尔珂] 每2秒施放一次刀风：伤害量20500% 移动速度 +15%  [精灵女王提泰妮娅]每5秒发动毁灭弹或毁灭斩击。 - 伤害量67500%  [停止攻击开关][装备主动技能]控制精灵们的攻击。 - 攻击中止/继续攻击 - 冷却时间1秒  [元素释放][装备主动技能]对精灵下达协同攻击指令。 - 消耗150精灵之魂 - 攻击时，精灵之魂 +10（冷却时间1秒） - 被击时，精灵之魂 -5（冷却时间1秒） - 元素释放伤害量：241700%
    # rarity: 太初
    char.equ_effect.append(EquEffect(name='火灵安珀', icon='/equipment/skill/29.png', cd=2, data=19200))
    char.equ_effect.append(EquEffect(name='水灵阿库娅', icon='/equipment/skill/29.png', cd=3, data=24000))
    char.equ_effect.append(EquEffect(name='风灵希尔珂', icon='/equipment/skill/29.png', cd=2, data=20500))
...
def suit_58(char: CharacterProperty):
    ...
    # level: 1
    # value: 根据防具/首饰/特殊装备的强化/增幅数值总和，适用以下效果。 - 超过110时，每11点，技能伤害 +2%（最多叠加2次） - 数值总和每达到+11时，技能范围 +2% (最多叠加12次) - 防具：数值每达到+5，所受物理/魔法伤害-1% (最多叠加12次) - 首饰：数值每达到+3，技能伤害 +1% (最多叠加12次) - 特殊装备：数值每达到+3，所有速度 +2% (最多叠加12次)  [淘银热] 根据防具/首饰/特殊装备的强化/增幅数值总和，降落相应数量的银币进行攻击（冷却时间10秒） * 银币伤害量信息  - 低于88：17000%  - 88~109：18700%  - 110~131：21250%  - 132以上：25500%  [辅助职业专属属性] 根据防具/首饰/特殊装备的强化/增幅数值总和，适用以下效果。 - 数值总和每达到+11时，技能冷却时间 -2% (最多叠加12次) - 110以上时，增益量 +750(最多叠加2次)
    # rarity: 史诗
    reinforce_0 = 0
    """防具"""
    reinforce_1 = 0
...
def suit_63(char: CharacterProperty):
    ...
    # level: 1
    # value: 根据防具/首饰/特殊装备的强化/增幅数值总和，适用以下效果。 - 超过110时，每11点，技能伤害 +2%（最多叠加2次） - 数值总和每达到+11时，技能范围 +2% (最多叠加12次) - 防具：数值每达到+5，所受物理/魔法伤害 -1% (最多叠加12次) - 首饰：数值每达到+3，技能伤害 +1% (最多叠加12次) - 特殊装备：数值每达到+3，所有速度 +2%(最多叠加12次)  [淘银热] 根据防具/首饰/特殊装备的强化/增幅数值总和，降落相应数量的银币进行攻击（冷却时间10秒） * 银币伤害量信息  - 低于88：17000%  - 88~109：18700%  - 110~131：21250%  - 132以上：25500%  [辅助职业专属属性] 根据防具/首饰/特殊装备的强化/增幅数值总和，适用以下效果。 - 数值总和每达到+11时，技能冷却时间 -2% (最多叠加12次) - 110以上时，数值每达到+11，增益量 +1500 (最多叠加2次)
    # rarity: 太初
    reinforce_0 = 0
    """防具"""
    reinforce_1 = 0
...
def suit_74(char: CharacterProperty):
    ...
    # level: 1
    # value: 通过释放龙之力来增强自己。  [虬龙之火] 无色小晶块消耗量减少1个。 - 不会减少到少于1个 所有速度 +10%  [蛟龙腾霄] 攻击时，蛟龙腾霄。 (冷却时间10秒) * 蛟龙腾霄伤害量：14,400%
    # rarity: 传说
    char.SetStatus(SpeedA=0.1, SpeedM=0.1, SpeedR=0.1)
...
def suit_79(char: CharacterProperty):
    ...
    # level: 1
    # value: 通过释放龙之力来增强自己。  [烛龙之火] 无色小晶块消耗量减少3个。 - 不会减少到少于1个 所有速度 +10%  [烛龙腾霄] 攻击时，烛龙腾霄。（冷却时间10秒） * 烛龙腾霄伤害量：14,400%  [荧惑如意珠][装备主动技能] 将[烛龙之火]变更为[烛龙的如意珠]，效果持续30秒。 - 删除无色小晶块消耗量减少效果 - 所有速度增加效果变更为30% - 技能伤害 +3% - 无色小晶块技能的消耗量固定30个 - 施放消耗无色小晶块的技能时，发动白龙强袭（冷却时间3秒） * 白龙强袭伤害量：10980% - 冷却时间60秒
    # rarity: 史诗
...
def suit_84(char: CharacterProperty):
    ...
    # level: 1
    # value: 通过释放龙之力来增强自己。  [应龙之火] 无色小晶块消耗量减少5个。 - 不会减少到小于1个 所有速度 +10%  [应龙腾霄] 攻击时，应龙腾霄。（冷却时间10秒） * 应龙腾霄伤害量：14,400%  [荧惑如意珠][装备主动技能] 将[应龙之火]变更为[应龙的如意珠] - 删除无色小晶块消耗量减少效果 - 所有速度增加效果变更为30% - 技能伤害 +3% - 无色小晶块技能的消耗量固定15个 - 施放消耗无色小晶块的技能时，白龙强袭（冷却时间3秒） * 白龙强袭伤害量：10980% - 再次使用，解除效果  [应龙之怒] [应龙的如意珠]效果生效状态下攻击时，黑龙横扫敌人。（冷却时间4秒） * 横扫伤害量：10200%
    # rarity: 太初
    if char.equ_options.get('1', 0) == 0:
        char.SetStatus(SpeedA=0.1, SpeedM=0.1, SpeedR=0.1)
...
def suit_90(char: CharacterProperty):
    ...
    # level: 1
    # value: 进入地下城时，净化状态自动生效  [净化] - 技能冷却时间 -30.0%（觉醒技能除外） - 特效伤害 +15% - 每秒恢复0.5%的生命值和魔法值
    # rarity: 神器
...
def suit_95(char: CharacterProperty):
    ...
    # level: 1
    # value: [暗黑净化][装备主动技能]根据使用者的意愿调整净化与堕落状态。 - 进入地下城时，净化状态自动生效 - 冷却时间：300秒  [净化] - 技能伤害 +17.5% - 技能冷却时间 -30%（觉醒技能除外） - 特效伤害 +15% - 每秒恢复0.5%的生命值和魔法值  [堕落] - 技能冷却时间 -55%（觉醒技能除外） - 特效伤害 +27.5% - 进入霸体状态
    # rarity: 传说
...
def suit_100(char: CharacterProperty):
    ...
    # level: 1
    # value: [暗黑净化][装备主动技能] 根据使用者的意愿调整净化与堕落状态。 - 进入地下城时，净化状态自动生效 - 冷却时间：300秒  [净化] - 技能伤害 +17.5% - 技能冷却时间 -30%（觉醒技能除外） - 特效伤害 +15% - 每秒恢复0.5%的生命值和魔法值 - 每10秒生成最大生命值10%的保护罩  [堕落] - 技能冷却时间 -55%（觉醒技能除外） - 特效伤害 +27.5% - 进入霸体状态 - 跳跃时可以再跳跃一次
    # rarity: 史诗
    suit_95(char)
    pass
...
def suit_105(char: CharacterProperty):
    ...
    # level: 1
    # value: 净化与堕落达到协调后，进入均衡状态。  [均衡] - 每秒恢复0.5%的生命值和魔法值 - 每10秒生成最大生命值10%的保护罩 - 进入霸体状态 - 跳跃时可以再跳跃一次  [暗黑净化] [装备发动属性] 选择使用净化和堕落的力量。 进入地下城时，净化状态自动生效 - 冷却时间300秒  [净化] - 技能伤害 +17.5% - 技能冷却时间 -30.0%（觉醒技能除外） - 特效伤害 +15%  [堕落] - 技能冷却时间  -55.0%（觉醒技能除外） - 特效伤害 +27.5%
    # rarity: 太初
    suit_95(char)
    pass
...
def suit_111(char: CharacterProperty):
    ...
    # level: 1
    # value: 幸运蝴蝶以一定几率初始化技能冷却时间，从而提供更多的技能使用机会。  [第一次幸运] - 技能伤害 +3% - 特效伤害 +3%  [天命所归] - 攻击时，有1%几率发动[天命所归]。（发动机会冷却时间1秒） - 剩余冷却时间33秒以下的技能中，初始化剩余时间最长的1个技能（觉醒技能除外）
    # rarity: 神器
    char.SetStatus(SkillAttack=0.03)
...
def suit_126(char: CharacterProperty):
    ...
    # level: 1
    # value: 幸运蝴蝶以一定几率初始化技能冷却时间，从而提供更多的技能使用机会。  [第一次幸运] - 技能伤害 +3% - 特效伤害 +19.5%  [第二次幸运] - 攻击时，有3%的几率使所有属性强化 +33（持续时间33秒；发动机会冷却时间1秒）  [天命所归] - 攻击时，有3%几率发动[天命所归]。（发动机会冷却时间1秒） - 剩余冷却时间33秒以下的技能中，初始化剩余时间最长的1个技能（觉醒技能除外） - 剩余冷却时间33秒以下的技能中，初始化剩余时间最短的1个技能（觉醒技能除外） - 当技能冷却时间生效中的技能超过3个时，初始化剩余冷却时间超过33秒的所有技能（觉醒技能除外，冷却时间33秒） - 立即发动[第二次幸运]  [幸运之翼][装备主动技能] - [第二次幸运]、[天命所归]发动几率提高3倍，效果持续33秒 - 立即发动[第二次幸运] - [幸运之翼]结束时发动[天命所归]，33秒后可以再次使用
    # rarity: 太初
    char.SetStatus(SkillAttack=0.03)
    char.AddElementDB('火',33,1)
    char.AddElementDB('冰',33,1)
...
def suit_137(char: CharacterProperty):
    ...
    # level: 1
    # value: 觉醒技能发挥出超越极限的破坏力。  [限制器解除] - 解除觉醒技能关联 - 100级技能攻击力 +40% - 85级技能攻击力 +40% - 100级技能冷却时间 -50% - 85级技能冷却时间 -40%  -50级技能冷却时间  -50%  - 特效伤害 +16.5%  * 组队时，辅助职业不适用解除觉醒技能关联、减少技能冷却时间的属性  [能量填充] 施放50、85级技能时，获得能量保护罩。（相同技能时冷却时间30秒） - 施放施放50、85级技能时，30秒内赋予生命值最大值15%的保护罩。（最多30%） - 保护罩持续时间内，每秒恢复1%的魔法值。 - 保护罩持续时间内，所有速度 +10%
    # rarity: 传说
    if not char.buffer:
...
def suit_138(char: CharacterProperty):
    ...
    # level: 2
    # value: 觉醒技能发挥出超越极限的破坏力。  [限制器解除] - 解除觉醒技能关联 - 100级技能攻击力 +40% - 85级技能攻击力 +40% - 100级技能冷却时间 -50% - 85级技能冷却时间 -40%  -50级技能冷却时间  -50%  - 特效伤害 +16.5%  * 组队时，辅助职业不适用解除觉醒技能关联、减少技能冷却时间的属性  [能量填充] 施放50、85级技能时，赋予能量保护罩。（施放相同技能时冷却时间30秒） - 施放施放50、85级技能时，30秒内赋予生命值最大值15%的保护罩。（最多30%） - 保护罩持续时间内，每秒恢复1%的魔法值。 - 保护罩持续时间内，所有速度 +10%
    # rarity: 传说
    suit_137(char)
    pass
...
def suit_142(char: CharacterProperty):
    ...
    # level: 1
    # value: 觉醒技能发挥出超越极限的破坏力。  [限制器解除] - 解除觉醒技能关联 - 100级技能攻击力 +60% - 85级技能攻击力 +50%  -50级技能攻击力 +10% - 100级技能冷却时间 -60% - 85级技能冷却时间  -50%  -50级技能冷却时间 -70%  - 特效伤害 +23%  * 组队时，辅助职业不适用解除觉醒技能关联、减少技能冷却时间的属性  [抵达极限的能量] 施放三觉技能时，突破极限 - 突破极限伤害量：331000% - 该伤害量适用于特效伤害  [能量填充] 施放50、85级技能时，赋予能量保护罩。（施放相同技能时冷却时间30秒） - 施放施放50、85级技能时，30秒内赋予生命值最大值15%的保护罩。（最多30%） - 保护罩持续时间内，每秒恢复1%的魔法值。 - 保护罩持续时间内，所有速度 +10%  辅助职业专属属性 施放50、100级技能时，30秒内赋予队友霸体状态。
    # rarity: 史诗
    if not char.buffer:
...
def suit_163(char: CharacterProperty):
    ...
    # level: 1
    # value: 利用无可违背的自然之力，对敌人造成巨大伤害。  所有速度 +5% 技能范围 +5%  [无可违背的自然 - 干预] 攻击时引发落雷，攻击大范围敌人。 (冷却时间5秒) - 落雷伤害55500%
    # rarity: 史诗
...
def suit_168(char: CharacterProperty):
    ...
    # level: 1
    # value: 利用无可违背的自然之力，对敌人造成巨大伤害。  所有速度 +10% 技能范围 +10%  [无可违背的自然- 灾变] 攻击时引发暴风雪，攻击地图上的所有敌人。（冷却时间5秒） - 暴风雪伤害量 77700%  [狂澜怒涛][装备主动技能] 发动狂澜怒涛，攻击地图上的所有敌人。 - 狂澜怒涛伤害量241500% - 冷却时间：60秒
    # rarity: 太初
...
def suit_174(char: CharacterProperty):
    ...
    # level: 1
    # value: 借用女武神的一部分神秘力量。  [突破] [装备发动属性] 与女武神融合，向前方突进。 - 正面突破伤害：10200% - 冷却时间8秒
    # rarity: 神器
...
def suit_179(char: CharacterProperty):
    ...
    # level: 1
    # value: 借用女武神的一部分神秘力量。  [突破] [装备发动属性] 与女武神融合，向前方突进。 - 正面突破伤害：10200% - 冷却时间8秒  [审判][装备发动属性] 与女武神融合，移动到敌人后方进行攻击。 - 审判伤害：19000% - 冷却时间15秒
    # rarity: 传说
    char.equ_effect.append(EquEffect(name='突破', icon='/equipment/skill/0.png', cd=8, data=10200))
...
def suit_184(char: CharacterProperty):
    ...
    # level: 1
    # value: 借用女武神的一部分神秘力量。  [突破] [装备发动属性]  与女武神融合，向前方突进。 - 正面突破伤害：10200% - 冷却时间8秒  [审判][装备发动属性] 与女武神融合，移动到敌人后方进行攻击。 - 审判伤害：19000% - 冷却时间15秒  施放无色小晶块技能时，获得“女武神的意志”。（最多8个）  [天罚] 充满“女武神意志”后发动攻击，可召唤女武神，对四周敌人施以天罚。 - 天罚伤害：200400% - 冷却时间20秒  辅助职业专属属性 发动[天罚]时，使周围800px内的队友恢复10%的生命值和魔法值。
    # rarity: 史诗
    char.equ_effect.append(EquEffect(name='突破', icon='/equipment/skill/0.png', cd=8, data=10200))
    char.equ_effect.append(EquEffect(name='审判', icon='/equipment/skill/1.png', cd=15, data=19000))
...
def suit_189(char: CharacterProperty):
    ...
    # level: 1
    # value: 借用女武神的一部分神秘力量。  [突破][装备发动属性] 与女武神融合，向前方突进。 - 正面突破伤害：10200% - 冷却时间8秒  [审判][装备发动属性] 与女武神融合，移动到敌人后方进行攻击。 - 审判伤害：19000% - 冷却时间15秒  [降临][装备主动技能] 发挥女武神真正的力量，降临世间。 - 降临伤害量：329400% - 冷却时间：140秒  施放无色小晶块技能时，可以获得“女武神意志”。（最多8个）  [天罚] 充满“女武神意志”后发动攻击，可召唤女武神，对四周敌人施以天罚。 - 天罚伤害：233500% - 冷却时间20秒  辅助职业专属属性 发动[天罚]时，使周围800px内的队友恢复10%的生命值和魔法值。 发动[降临]时，使周围800px内的队友恢复30%的生命值和魔法值。
    # rarity: 太初
    char.equ_effect.append(EquEffect(name='突破', icon='/equipment/skill/0.png', cd=8, data=10200))
    char.equ_effect.append(EquEffect(name='审判', icon='/equipment/skill/1.png', cd=15, data=19000))
...
def suit_195(char: CharacterProperty):
    ...
    # level: 1
    # value: 借用青丘狐的灵珠之力，瞬间变强。[青丘灵珠]激活 - 攻击时，灵珠能量 +5（冷却时间1秒） - 灵珠最多可填充1个 - 青丘灵珠增益效果生效时，无法充能灵珠 - 进入地下城时，灵珠能量填充100  [青丘灵珠][装备主动技能] - 发动时，消耗能量充满的所有灵珠，激活增益效果 - 每消耗1个灵珠，技能伤害 +10% - 增益效果持续时间30秒 - 冷却时间30秒  辅助职业专属属性 发动[青丘灵珠]时，周围500px范围内的队员获得恢复光环，效果持续30秒。 - 每消耗1个灵珠，恢复0.25%的生命值和魔法值。
    # rarity: 神器
...
def suit_201(char: CharacterProperty):
    ...
    # level: 2
    # value: 借用青丘狐的灵珠之力，瞬间变强。[青丘灵珠]激活 - 攻击时，灵珠能量 +6（冷却时间1秒） - 每秒灵珠能量 +1 - 灵珠最多可填充2个 - 青丘灵珠增益效果生效时，也可以充能灵珠 - 进入地下城时，灵珠能量填充200 [青丘灵珠][装备主动技能] - 发动时，消耗能量充满的所有灵珠，激活增益效果 - 每消耗1个灵珠，技能伤害 +10% - 增益效果持续时间30秒 - 冷却时间30秒  辅助职业专属属性 发动[青丘灵珠]时，周围500px范围内的队员获得恢复光环，效果持续30秒。 - 每消耗1个灵珠，恢复0.25%的生命值和魔法值。
    # rarity: 传说
    suit_200(char)
    pass
...
def suit_210(char: CharacterProperty):
    ...
    # level: 1
    # value: 借用青丘狐的灵珠之力，瞬间变强。[青丘灵珠]激活 - 攻击时，灵珠能量 +11（冷却时间1秒） - 每秒灵珠能量 +6 - 灵珠最多可填充4个 - 青丘灵珠增益效果生效时，也可以充能灵珠 - 进入地下城时，灵珠能量填充400  [青丘灵珠][装备主动技能] - 发动时，消耗能量充满的所有灵珠，激活增益效果 - 每消耗1个灵珠，技能伤害 +10% - 增益效果持续时间30秒 - 冷却时间30秒  [青丘灵珠开关][装备主动技能] - 灵珠全部填满时，自动使用青丘灵珠增益效果（冷却时间1秒） - 再次使用时，关闭自动使用功能  辅助职业专属属性 发动[青丘灵珠]时，周围500px范围内的队员获得恢复光环，效果持续30秒。 - 每消耗1个灵珠，恢复0.25%的生命值和魔法值。
    # rarity: 太初
...
def suit_216(char: CharacterProperty):
    ...
    # level: 1
    # value: 与同伴在一起时，会变得更强。  [组队挑战时适用] [群猎之力] 给队员赋予光环，获得以下效果。 (最多叠加1次) - 所有速度 +10%  [酣畅狩猎][装备主动技能] 发出吼叫震慑敌人。 - 伤害量：3,825% - 使被命中的敌人进入崩裂状态，持续30秒 - 冷却时间10秒 （敌人进入崩裂状态时，所受伤害根据叠加层数(1/2/3)增加(5/7/8)%）  （[群猎之力]、[酣畅狩猎]效果对辅助职业无效）  [单人挑战时适用] - 技能伤害 +10.6% - 适用[群猎之力]效果 - 不适用[酣畅狩猎]效果  辅助职业专属属性 [辅助者群猎之力]效果发动 为队友赋予以下效果的光环（最多叠加1次） - 所有速度 +15% - [群猎之力]适用时，效果解除
    # rarity: 神器
...
def suit_221(char: CharacterProperty):
    ...
    # level: 1
    # value: 与同伴在一起时，会变得更强。  [组队挑战时适用] [群猎之力] 给队员赋予光环，获得以下效果。（最多叠加1次） - 所有速度 +15% - 每10秒恢复10000点的生命值和魔法值，持续10秒  [酣畅狩猎][装备主动技能] 发出吼叫震慑敌人。 - 伤害量：5,738% - 使被命中的敌人进入崩裂状态，持续45秒 - 冷却时间10秒 （敌人进入崩裂状态时，所受伤害根据叠加层数(1/2/3)增加(5/7/8)%）  （[群猎之力]、[酣畅狩猎]效果对辅助职业无效）  [单人挑战时适用] - 技能伤害 +14.4% - 适用[群猎之力]效果 - 不适用[酣畅狩猎]效果  辅助职业专属属性 [辅助者群猎之力]效果发动 为队友赋予以下效果的光环（最多叠加1次） - 所有速度 +15% - [群猎之力]适用时，效果解除
    # rarity: 传说
    if char.equ_options.get('3',0) == 0:
...
def suit_226(char: CharacterProperty):
    ...
    # level: 1
    # value: 与同伴在一起时，会变得更强。  [组队挑战时适用] [群猎之力] 给队员赋予光环，获得以下效果。（最多叠加1次） - 所有速度 +20% - 所受物理/魔法伤害- 10% - 每10秒恢复10000点的生命值和魔法值，持续10秒  [酣畅狩猎][装备主动技能] 发出吼叫震慑敌人。 - 伤害量：6,750% - 使被命中的敌人进入最大层数的崩裂状态，持续60秒 - 冷却时间30秒 （敌人进入崩裂状态时，所受伤害根据叠加层数(1/2/3)增加(5/7/8)%）  （[群猎之力]、[酣畅狩猎]效果对辅助职业无效）  [单人挑战时适用] - 技能伤害 +17.8% - 适用[群猎之力]效果 - 不适用[酣畅狩猎]效果  辅助职业专属属性 [辅助者群猎之力]效果发动 为队友赋予以下效果的光环（最多叠加1次） - 所有速度 +15% - [群猎之力]适用时，效果解除
    # rarity: 史诗
    if char.equ_options.get('3',0) == 0:
        char.SetStatus(SkillAttack=0.178)
    else:
...
def suit_231(char: CharacterProperty):
    ...
    # level: 1
    # value: 与同伴在一起时，会变得更强。  [组队挑战时适用] [群猎之力] 给队员赋予光环，获得以下效果。（最多叠加1次） - 所有速度 +30% - 所受物理/魔法伤害- 15% - 每10秒恢复10，000点的生命值和魔法值，持续10秒  [酣畅狩猎][装备主动技能] 发出吼叫震慑敌人。 - 施放时，每1秒对500px内敌人施加最大叠加层数的崩裂状态 - 再次施放时，不再叠加崩裂状态 - 冷却时间10秒 （敌人进入崩裂状态时，所受伤害根据叠加层数(1/2/3)增加(5/7/8)%）  （[群猎之力]、[酣畅狩猎]效果对辅助职业无效）  [单人挑战时适用] - 技能伤害 +21.6% - 适用[群猎之力]效果 - 不适用[酣畅狩猎]效果  辅助职业专属属性 [辅助者群猎之力]效果发动 为队友赋予以下效果的光环（最多叠加1次） - 所有速度 +15% - [群猎之力]适用时，效果解除
    # rarity: 太初
    if char.equ_options.get('3',0) == 0:
...
def suit_242(char: CharacterProperty):
    ...
    # level: 1
    # value: 操控魔攻核攻击敌人。  [魔攻核] 进入地下城时，召唤普通模式魔攻核。  [命令：转换][装备主动技能] 转换魔攻核的攻击模式。 - 普通模式/追击模式 - 冷却时间：5秒  [魔攻核：普通模式] 每秒发射魔力波动。 - 魔力波动伤害量：35000% - 魔力波动范围：150px - 移动速度 +25% - 进入霸体状态  [魔攻核：追击模式] 追击最强的敌人，每秒发射魔力波动。 - 魔力波动伤害量：21000% - 魔力波动范围：150px  [魔攻核：追踪模式] 攻击时，对赋予[追踪目标]的敌人发射魔力子弹 - 魔力子弹伤害量：7000% - 冷却时间：1秒
    # rarity: 传说
    if char.equ_options.get('4',0) == 0:
...
def suit_247(char: CharacterProperty):
    ...
    # level: 1
    # value: 操控魔攻核攻击敌人。  [魔攻核] 进入地下城时，召唤普通模式魔攻核。  [命令：转换][装备主动技能] 转换魔攻核的攻击模式。 - 普通模式/追击模式 - 冷却时间：5秒  [魔攻核：普通模式] 每秒发射魔力波动。 - 魔力波动伤害量：52500% - 魔力波动范围：150px - 移动速度 +25% - 进入霸体状态  [魔攻核：追击模式] 追击最强的敌人，每秒发射魔力波动。 - 魔力波动伤害量：31000% - 魔力波动范围：150px  [魔攻核：追踪模式] 攻击时，对赋予[追踪目标]的敌人发射魔力子弹 - 魔力子弹伤害量：11000% - 冷却时间：1秒
    # rarity: 史诗
    if char.equ_options.get('4',0) == 0:
...
def suit_252(char: CharacterProperty):
    ...
    # level: 1
    # value: 操控魔攻核攻击敌人。 [魔攻核] 进入地下城时，召唤普通模式魔攻核。  [命令：转换][装备主动技能] 转换魔攻核的攻击模式。 - 普通模式/追击模式 - 冷却时间：5秒  [魔攻核：普通模式] 每秒发射魔力波动。 - 魔力波动伤害量：67000% - 魔力波动范围：150px - 移动速度 +25% - 进入霸体状态  [魔攻核：追击模式] 追击最强的敌人，每秒发射魔力波动。 - 魔力波动伤害量：40000% - 魔力波动范围：150px  [魔攻核：追踪模式] 攻击时，对赋予[追踪目标]的敌人发射魔力子弹 - 魔力子弹伤害量：13600% - 冷却时间：1秒
    # rarity: 太初
    if char.equ_options.get('4',0) == 0:
