...
def suit_184(char: CharacterProperty):
    ...
    # level: 1
    # value: 借用女武神的一部分神秘力量。  [突破] [装备发动属性]  与女武神融合，向前方突进。 - 正面突破伤害：10200% - 冷却时间8秒  [审判][装备发动属性] 与女武神融合，移动到敌人后方进行攻击。 - 审判伤害：19000% - 冷却时间15秒  施放无色小晶块技能时，获得“女武神的意志”。（最多8个）  [天罚] “女武神的意志”达到上限时，攻击时召唤女武神，对四周敌人施以天罚。 - 天罚伤害：200400% - 冷却时间 ：20秒  - 辅助职业专属属性 [天罚]发动时，回复800px内队员10%最大生命值和最大魔法值 [审判]发动时，回复800px内队员30%最大生命值和最大魔法值
    # rarity: 史诗
    char.equ_effect.append(EquEffect(name='突破', icon='/equipment/skill/0.png', cd=8, data=10200))
    char.equ_effect.append(EquEffect(name='审判', icon='/equipment/skill/1.png', cd=15, data=19000))
...
def suit_189(char: CharacterProperty):
    ...
    # level: 1
    # value: 借用女武神的一部分神秘力量。  [突破] [装备发动属性]  与女武神融合，向前方突进。 - 正面突破伤害：10200% - 冷却时间8秒  [审判][装备发动属性] 与女武神融合，移动到敌人后方进行攻击。 - 审判伤害：19000% - 冷却时间15秒  施放无色小晶块技能时，获得“女武神的意志”。（最多8个）  [天罚] “女武神的意志”达到上限时，攻击时召唤女武神，对四周敌人施以天罚。 - 天罚伤害：233500% - 冷却时间 ：20秒  辅助职业专属属性 [天罚]发动时，回复800px内队员10%最大生命值和最大魔法值 [审判]发动时，回复800px内队员30%最大生命值和最大魔法值
    # rarity: 太初
    char.equ_effect.append(EquEffect(name='突破', icon='/equipment/skill/0.png', cd=8, data=10200))
    char.equ_effect.append(EquEffect(name='审判', icon='/equipment/skill/1.png', cd=15, data=19000))
