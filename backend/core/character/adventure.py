...
adv = [
    ...
    },
    {
        ...
        'children': [
            ...
            {'id': 2, 'name': 'mechanic_male', 'title': '重霄·机械师', 'open': True, 'class': 'GF.gunner_male.mechanic_male'},
    ...
    },
    {
        ...
        'title': '魔法师(男)',
        'children': [
            {'id': 0, 'name': 'elemental_bomber', 'title': '知源·元素爆破师', 'open': True, 'class': 'GF.mage_male.elemental_bomber'},
            {'id': 1, 'name': 'glacial_master', 'title': '知源·冰结师', 'open': True, 'class': 'GF.mage_male.glacial_master'},
            {'id': 2, 'name': 'blood_mage', 'title': '知源·血法师', 'open': True, 'class': 'GF.mage_male.blood_mage'},
            {'id': 3, 'name': 'swift_master', 'title': '知源·逐风者', 'open': True, 'class': 'GF.mage_male.swift_master'},
    ...
    },
    {
        ...
        'children': [
            ...
            {'id': 2, 'name': 'battle_mage', 'title': '知源·战斗法师', 'open': True, 'class': 'GF.mage_female.battle_mage'},
            {'id': 3, 'name': 'witch', 'title': '知源·魔道学者', 'open': True, 'class': 'GF.mage_female.witch'},
            {
                'id': 4,
                'name': 'enchantress',
                'title': '知源·小魔女',
                'open': True,
                'class': 'GF.mage_female.enchantress',
            },
        ],
    },
    {
        ...
        'children': [
            {
                ...
                'title': '神启·圣骑士',
                'open': True,
                'class': 'GF.priest_male.crusader_male',
                # 'options': [{'id': 0, 'name': 'default', 'title': '奶', 'class': 'crusader_male'}, {'id': 1, 'name': 'default', 'title': '审判', 'class': 'crusader_male_carry'}],
            },
            {'id': 1, 'name': 'infighter', 'title': '神启·蓝拳圣使', 'open': True, 'class': 'GF.priest_male.infighter'},
            {'id': 2, 'name': 'exorcist', 'title': '神启·驱魔师', 'open': True, 'class': 'GF.priest_male.exorcist'},
            {'id': 3, 'name': 'avenger', 'title': '神启·复仇者', 'open': True, 'class': 'GF.priest_male.avenger'},
    ...
    },
    {
        ...
        'children': [
            ...
            {'id': 2, 'name': 'kunoichi', 'title': '隐夜·忍者', 'open': True, 'class': 'GF.thief.kunoichi'},
            {'id': 3, 'name': 'shadow_dancer', 'title': '隐夜·影舞者', 'open': True, 'class': 'GF.thief.shadow_dancer'},
            {'id': 4, 'name': 'empty', 'title': ''},
        ],
    },
    {
        ...
        'children': [
            ...
            {'id': 2, 'name': 'paladin', 'title': '皓曦·帕拉丁', 'open': True, 'class': 'GF.knight.paladin'},
    ...
    },
    {
        ...
        'children': [
            ...
            {'id': 1, 'name': 'traveler', 'title': '聆风·旅人', 'open': True, 'class': 'GF.archer.traveler'},
            {'id': 2, 'name': 'hunter', 'title': '聆风·猎人', 'open': True, 'class': 'GF.archer.hunter'},
            {'id': 3, 'name': 'vigilante', 'title': '聆风·妖护使', 'open': True, 'class': 'GF.archer.vigilante'},
