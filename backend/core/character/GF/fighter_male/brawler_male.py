...
class Skill26(ActiveSkill):
    ...
    associate = [
        {"type":"+power1","data":[100-i if i > 0 else i for i in data2],"skills":["抛沙"]},
        {"type":"+power4","data":[100-i if i > 0 else i for i in data4],"skills":["毒瓶投掷"]},
...
class Skill30(ActiveSkill):
    ...
    def setMode(self, mode):
        if mode == "常规":
            ...
            self.hit0 = self.hit1 = self.hit5 = self.hit6 = 0
