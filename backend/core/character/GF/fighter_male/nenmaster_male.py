...
class Skill33(ActiveSkill):
    ...
    associate = [
        {"type":"*power2","data":data0,"skills":["念气环绕"]}
    ]
...
class Skill43(ActiveSkill):
    ...
    associate = [
        ...
        {"data":data1,"type":"+power0","skills":["狮子吼"]},
        {"data":data1,"type":"+power0","skills":["天雷虎踢"]},
        {"data":data1,"type":"+power1","skills":["天雷虎踢"]},
        {"data":data1,"type":"+power3","skills":["天雷虎踢"]},
        {"data":data1,"type":"+power0","skills":["螺旋念气场"]},
        {"data":data1,"type":"+power2","skills":["螺旋念气场"]},
        {"data":data1,"type":"+power0","skills":["念兽 : 猛虎震地"]},
        {"data":data1,"type":"+power2","skills":["念兽 : 猛虎震地"]},
        {"data":data1,"type":"+power0","skills":["念兽 : 审判之金雷虎"]},
        {"data":data1,"type":"+power1","skills":["念兽 : 审判之金雷虎"]},
        {"data":data1,"type":"+power3","skills":["念兽 : 审判之金雷虎"]},   
        {"data":data1,"type":"+power0","skills":["念之战矛"]},
        {"data":data1,"type":"+power1","skills":["念之战矛"]},
        {"data":data1,"type":"+power2","skills":["念之战矛"]},         
        {"data":data1,"type":"+power0","skills":["冲云念气场"]},
        {"data":data1,"type":"+power2","skills":["冲云念气场"]}, 
        {"data":data1,"type":"+power0","skills":["奔雷螺旋击"]},
        {"data":data1,"type":"+power0","skills":["禅语·形灭"]},
        {"data":data1,"type":"+power2","skills":["禅语·形灭"]},        
    ]
